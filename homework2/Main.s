...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if itemCount != 5 then goto _Label_581		(int)
	load	[r14+8],r1
	load	[r1+80],r1
	mov	5,r2
	cmp	r1,r2
	bne	_Label_581
!	_Label_580	jmp	_Label_580
_Label_580:
! THEN...
...
!   _temp_583 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-72]
!   Move address of _temp_583 [bufferNextIn ] into _temp_584
!     make sure index expr is >= 0
	load	[r14+8],r2
	load	[r2+16],r2
	cmp	r2,0
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-68]
!   Data Move: *_temp_584 = c  (sizeInBytes=1)
	loadb	[r14+12],r1
	load	[r14+-68],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
!   _temp_585 = bufferNextIn + 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-64]
!   bufferNextIn = _temp_585 rem 5		(int)
	load	[r14+-64],r1
	mov	5,r2
	cmp	r2,0
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if itemCount != 1 then goto _Label_587		(int)
	load	[r14+8],r1
	load	[r1+80],r1
	mov	1,r2
	cmp	r1,r2
...
!   if intIsZero (_P_Thread_currentThread) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_591 = _P_Thread_currentThread + 72
	set	_P_Thread_currentThread,r1
	load	[r1],r1
	add	r1,72,r1
	store	r1,[r14+-48]
...
!   _temp_596 = 1		(4 bytes)
	...
	store	r1,[r14+-44]
!   Calculate and save the FOR-LOOP ending value
!   _temp_597 = bufferLength		(4 bytes)
	load	[r14+8],r1
	load	[r1+24],r1
	store	r1,[r14+-40]
!   Initialize FOR-LOOP index variable
...
!   _temp_599 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-36]
!   Move address of _temp_599 [j ] into _temp_600
!     make sure index expr is >= 0
	load	[r14+-88],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-32]
!   Data Move: _temp_598 = *_temp_600  (sizeInBytes=1)
	load	[r14+-32],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Prepare Argument: offset=8  value=_temp_598  sizeInBytes=1
	loadb	[r14+-9],r1
	storeb	r1,[r15+0]
!   Call the function
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (itemCount) then goto _Label_633
	load	[r14+8],r1
	load	[r1+80],r1
	cmp	r1,r0
	be	_Label_633
...
!   _temp_636 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-72]
!   Move address of _temp_636 [bufferNextOut ] into _temp_637
!     make sure index expr is >= 0
	load	[r14+8],r2
	load	[r2+20],r2
	cmp	r2,0
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-68]
!   Data Move: c = *_temp_637  (sizeInBytes=1)
	load	[r14+-68],r1
	loadb	[r1],r1
	storeb	r1,[r14+-10]
! ASSIGNMENT STATEMENT...
...
!   _temp_638 = bufferNextOut + 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-64]
!   bufferNextOut = _temp_638 rem 5		(int)
	load	[r14+-64],r1
	mov	5,r2
	cmp	r2,0
	be	_runtimeErrorZeroDivide
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if itemCount != 4 then goto _Label_640		(int)
	load	[r14+8],r1
	load	[r1+80],r1
	mov	4,r2
	cmp	r1,r2
...
!   _temp_649 = 1		(4 bytes)
	...
	store	r1,[r14+-44]
!   Calculate and save the FOR-LOOP ending value
!   _temp_650 = bufferLength		(4 bytes)
	load	[r14+8],r1
	load	[r1+24],r1
	store	r1,[r14+-40]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_649  (sizeInBytes=4)
	load	[r14+-44],r1
	store	r1,[r14+-84]
_Label_645:
!   Perform the FOR-LOOP termination test
!   if i > _temp_650 then goto _Label_648		
	load	[r14+-84],r1
	load	[r14+-40],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_652 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-36]
!   Move address of _temp_652 [j ] into _temp_653
!     make sure index expr is >= 0
	load	[r14+-88],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-32]
!   Data Move: _temp_651 = *_temp_653  (sizeInBytes=1)
	load	[r14+-32],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Prepare Argument: offset=8  value=_temp_651  sizeInBytes=1
	loadb	[r14+-9],r1
	storeb	r1,[r15+0]
!   Call the function
...
!   _temp_660 = 5 - bufferLength		(int)
	...
	store	r1,[r14+-20]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_659  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+-84]
_Label_655:
!   Perform the FOR-LOOP termination test
!   if i > _temp_660 then goto _Label_658		
	load	[r14+-84],r1
	load	[r14+-20],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
