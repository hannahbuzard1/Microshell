...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if itemCount != 5 then goto _Label_577		(int)
	load	[r14+8],r1
	load	[r1+80],r1
	mov	5,r2
	cmp	r1,r2
...
!   _temp_579 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-72]
!   Move address of _temp_579 [bufferNextIn ] into _temp_580
!     make sure index expr is >= 0
	load	[r14+8],r2
	load	[r2+16],r2
	cmp	r2,0
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-68]
!   Data Move: *_temp_580 = c  (sizeInBytes=1)
	loadb	[r14+12],r1
	load	[r14+-68],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
!   _temp_581 = bufferNextIn + 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-64]
!   bufferNextIn = _temp_581 rem 5		(int)
	load	[r14+-64],r1
	mov	5,r2
	cmp	r2,0
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if itemCount != 1 then goto _Label_583		(int)
	load	[r14+8],r1
	load	[r1+80],r1
	mov	1,r2
	cmp	r1,r2
...
!   if intIsZero (_P_Thread_currentThread) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_587 = _P_Thread_currentThread + 72
	set	_P_Thread_currentThread,r1
	load	[r1],r1
	add	r1,72,r1
	store	r1,[r14+-48]
...
!   _temp_592 = 1		(4 bytes)
	...
	store	r1,[r14+-44]
!   Calculate and save the FOR-LOOP ending value
!   _temp_593 = bufferLength		(4 bytes)
	load	[r14+8],r1
	load	[r1+24],r1
	store	r1,[r14+-40]
!   Initialize FOR-LOOP index variable
...
!   _temp_595 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-36]
!   Move address of _temp_595 [j ] into _temp_596
!     make sure index expr is >= 0
	load	[r14+-88],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-32]
!   Data Move: _temp_594 = *_temp_596  (sizeInBytes=1)
	load	[r14+-32],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Prepare Argument: offset=8  value=_temp_594  sizeInBytes=1
	loadb	[r14+-9],r1
	storeb	r1,[r15+0]
!   Call the function
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (itemCount) then goto _Label_629
	load	[r14+8],r1
	load	[r1+80],r1
	cmp	r1,r0
	be	_Label_629
...
!   _temp_632 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-72]
!   Move address of _temp_632 [bufferNextOut ] into _temp_633
!     make sure index expr is >= 0
	load	[r14+8],r2
	load	[r2+20],r2
	cmp	r2,0
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-68]
!   Data Move: c = *_temp_633  (sizeInBytes=1)
	load	[r14+-68],r1
	loadb	[r1],r1
	storeb	r1,[r14+-10]
! ASSIGNMENT STATEMENT...
...
!   _temp_634 = bufferNextOut + 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-64]
!   bufferNextOut = _temp_634 rem 5		(int)
	load	[r14+-64],r1
	mov	5,r2
	cmp	r2,0
	be	_runtimeErrorZeroDivide
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if itemCount != 4 then goto _Label_636		(int)
	load	[r14+8],r1
	load	[r1+80],r1
	mov	4,r2
	cmp	r1,r2
...
!   _temp_645 = 1		(4 bytes)
	...
	store	r1,[r14+-44]
!   Calculate and save the FOR-LOOP ending value
!   _temp_646 = bufferLength		(4 bytes)
	load	[r14+8],r1
	load	[r1+24],r1
	store	r1,[r14+-40]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_645  (sizeInBytes=4)
	load	[r14+-44],r1
	store	r1,[r14+-84]
_Label_641:
!   Perform the FOR-LOOP termination test
!   if i > _temp_646 then goto _Label_644		
	load	[r14+-84],r1
	load	[r14+-40],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_648 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-36]
!   Move address of _temp_648 [j ] into _temp_649
!     make sure index expr is >= 0
	load	[r14+-88],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-32]
!   Data Move: _temp_647 = *_temp_649  (sizeInBytes=1)
	load	[r14+-32],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Prepare Argument: offset=8  value=_temp_647  sizeInBytes=1
	loadb	[r14+-9],r1
	storeb	r1,[r15+0]
!   Call the function
