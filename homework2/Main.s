...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: myMutex = zeros  (sizeInBytes=20)
	load	[r14+8],r4
	add	r4,60,r4
	store	r0,[r4]
	store	r0,[r4+4]
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_597:
!   if itemCount != 5 then goto _Label_599		(int)
	load	[r14+8],r1
	load	[r1+80],r1
	mov	5,r2
	cmp	r1,r2
...
!   _temp_600 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-72]
!   Move address of _temp_600 [bufferNextIn ] into _temp_601
!     make sure index expr is >= 0
	load	[r14+8],r2
	load	[r2+16],r2
	cmp	r2,0
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-68]
!   Data Move: *_temp_601 = c  (sizeInBytes=1)
	loadb	[r14+12],r1
	load	[r14+-68],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
!   _temp_602 = bufferNextIn + 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-64]
!   bufferNextIn = _temp_602 rem 5		(int)
	load	[r14+-64],r1
	mov	5,r2
	cmp	r2,0
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if itemCount <= 0 then goto _Label_604		(int)
	load	[r14+8],r1
	load	[r1+80],r1
	mov	0,r2
	cmp	r1,r2
...
!   _temp_605 = &not_empty
	...
	add	r1,44,r1
	store	r1,[r14+-60]
!   Prepare Argument: offset=12  value=mutexPtr  sizeInBytes=4
	load	[r14+8],r1
	load	[r1+84],r1
	store	r1,[r15+4]
!   Send message Signal
...
!   _temp_613 = 1		(4 bytes)
	...
	store	r1,[r14+-44]
!   Calculate and save the FOR-LOOP ending value
!   _temp_614 = bufferLength		(4 bytes)
	load	[r14+8],r1
	load	[r1+24],r1
	store	r1,[r14+-40]
!   Initialize FOR-LOOP index variable
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_649:
!   if intIsZero (itemCount) then goto _Label_650
	load	[r14+8],r1
	load	[r1+80],r1
	cmp	r1,r0
	be	_Label_650
...
!   _temp_653 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-72]
!   Move address of _temp_653 [bufferNextOut ] into _temp_654
!     make sure index expr is >= 0
	load	[r14+8],r2
	load	[r2+20],r2
	cmp	r2,0
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-68]
!   Data Move: c = *_temp_654  (sizeInBytes=1)
	load	[r14+-68],r1
	loadb	[r1],r1
	storeb	r1,[r14+-10]
! ASSIGNMENT STATEMENT...
...
!   _temp_655 = bufferNextOut + 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-64]
!   bufferNextOut = _temp_655 rem 5		(int)
	load	[r14+-64],r1
	mov	5,r2
	cmp	r2,0
	be	_runtimeErrorZeroDivide
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if itemCount != 4 then goto _Label_657		(int)
	load	[r14+8],r1
	load	[r1+80],r1
	mov	4,r2
	cmp	r1,r2
...
!   if intIsZero (_P_Thread_currentThread) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_661 = _P_Thread_currentThread + 72
	set	_P_Thread_currentThread,r1
	load	[r1],r1
	add	r1,72,r1
	store	r1,[r14+-48]
...
!   _temp_666 = 1		(4 bytes)
	...
	store	r1,[r14+-44]
!   Calculate and save the FOR-LOOP ending value
!   _temp_667 = bufferLength		(4 bytes)
	load	[r14+8],r1
	load	[r1+24],r1
	store	r1,[r14+-40]
!   Initialize FOR-LOOP index variable
...
!   _temp_669 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-36]
!   Move address of _temp_669 [j ] into _temp_670
!     make sure index expr is >= 0
	load	[r14+-88],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-32]
!   Data Move: _temp_668 = *_temp_670  (sizeInBytes=1)
	load	[r14+-32],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Prepare Argument: offset=8  value=_temp_668  sizeInBytes=1
	loadb	[r14+-9],r1
	storeb	r1,[r15+0]
!   Call the function
...
!   _temp_677 = 5 - bufferLength		(int)
	...
	store	r1,[r14+-20]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_676  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+-84]
_Label_672:
!   Perform the FOR-LOOP termination test
!   if i > _temp_677 then goto _Label_675		
	load	[r14+-84],r1
	load	[r14+-20],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
