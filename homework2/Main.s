...
!   _temp_601 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-72]
!   Move address of _temp_601 [bufferNextIn ] into _temp_602
!     make sure index expr is >= 0
	load	[r14+8],r2
	load	[r2+16],r2
	cmp	r2,0
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-68]
!   Data Move: *_temp_602 = c  (sizeInBytes=1)
	loadb	[r14+12],r1
	load	[r14+-68],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
!   _temp_603 = bufferNextIn + 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-64]
!   bufferNextIn = _temp_603 rem 5		(int)
	load	[r14+-64],r1
	mov	5,r2
	cmp	r2,0
...
!   if intIsZero (_P_Thread_currentThread) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_609 = _P_Thread_currentThread + 72
	set	_P_Thread_currentThread,r1
	load	[r1],r1
	add	r1,72,r1
	store	r1,[r14+-48]
...
!   _temp_614 = 1		(4 bytes)
	...
	store	r1,[r14+-44]
!   Calculate and save the FOR-LOOP ending value
!   _temp_615 = bufferLength		(4 bytes)
	load	[r14+8],r1
	load	[r1+24],r1
	store	r1,[r14+-40]
!   Initialize FOR-LOOP index variable
...
!   _temp_617 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-36]
!   Move address of _temp_617 [j ] into _temp_618
!     make sure index expr is >= 0
	load	[r14+-88],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-32]
!   Data Move: _temp_616 = *_temp_618  (sizeInBytes=1)
	load	[r14+-32],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Prepare Argument: offset=8  value=_temp_616  sizeInBytes=1
	loadb	[r14+-9],r1
	storeb	r1,[r15+0]
!   Call the function
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (itemCount) then goto _Label_651
	load	[r14+8],r1
	load	[r1+80],r1
	cmp	r1,r0
	be	_Label_651
...
!   _temp_654 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-72]
!   Move address of _temp_654 [bufferNextOut ] into _temp_655
!     make sure index expr is >= 0
	load	[r14+8],r2
	load	[r2+20],r2
	cmp	r2,0
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-68]
!   Data Move: c = *_temp_655  (sizeInBytes=1)
	load	[r14+-68],r1
	loadb	[r1],r1
	storeb	r1,[r14+-10]
! ASSIGNMENT STATEMENT...
...
!   _temp_656 = bufferNextOut + 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-64]
!   bufferNextOut = _temp_656 rem 5		(int)
	load	[r14+-64],r1
	mov	5,r2
	cmp	r2,0
	be	_runtimeErrorZeroDivide
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if itemCount != 4 then goto _Label_658		(int)
	load	[r14+8],r1
	load	[r1+80],r1
	mov	4,r2
	cmp	r1,r2
	bne	_Label_658
!	_Label_657	jmp	_Label_657
_Label_657:
! THEN...
...
!   if intIsZero (_P_Thread_currentThread) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_662 = _P_Thread_currentThread + 72
	set	_P_Thread_currentThread,r1
	load	[r1],r1
	add	r1,72,r1
	store	r1,[r14+-48]
...
!   _temp_667 = 1		(4 bytes)
	...
	store	r1,[r14+-44]
!   Calculate and save the FOR-LOOP ending value
!   _temp_668 = bufferLength		(4 bytes)
	load	[r14+8],r1
	load	[r1+24],r1
	store	r1,[r14+-40]
!   Initialize FOR-LOOP index variable
...
!   _temp_670 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-36]
!   Move address of _temp_670 [j ] into _temp_671
!     make sure index expr is >= 0
	load	[r14+-88],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-32]
!   Data Move: _temp_669 = *_temp_671  (sizeInBytes=1)
	load	[r14+-32],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Prepare Argument: offset=8  value=_temp_669  sizeInBytes=1
	loadb	[r14+-9],r1
	storeb	r1,[r15+0]
!   Call the function
